...
Capability spread, self-assessed &mdash; not calibrated against any external scale. Strongest: frontend, state/API integration. Growing fast: AI/LLM integration. Testing is the honest growth edge.
